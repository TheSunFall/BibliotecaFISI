...
import com.BibliotecaFISI.lib.BordeRedondeado;
import com.BibliotecaFISI.lib.Sesion;
import com.BibliotecaFISI.lib.Usuario;
import com.BibliotecaFISI.lib.VerificadorInicioSesion;
...
public class InicioSesion extends javax.swing.JFrame {
    ...
    public InicioSesion() {
        initComponents();
        jPanel2.setBorder(new BordeRedondeado(16));
    }
    ...
    private void initComponents() {
        ...
        label2.setText("SISTEMA DE GESTIÓN BIBLIOTECARIA FISI");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            VerificadorInicioSesion auth = new VerificadorInicioSesion();
            ...
            if (usuario != null) {
                ...
                new PaginaInicio(usuario).setVisible(true);
                this.dispose();
            } else {
